    ...
    return (
        <Modal title={props.title} closeModal={props.closeModal} className="max-w-lg">
            <form onSubmit={props.submit}>
                <div className="my-4">
                    <InputLabel value={name} onChange={(e) => setName(e.target.value)} label="Jenis Tunjangan" name={NAME} type="text" placeHolder="Masukkan janis tunjangan" isRequired={true} />
                </div>
